          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              <Button
                ...
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-lg shadow-[0_0_30px_rgba(255,0,0,0.4)] hover:shadow-[0_0_40px_rgba(255,0,0,0.6)] transition-all duration-300"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="px-8 py-6 text-lg border-foreground/20 hover:border-primary hover:bg-primary/10"
              >
